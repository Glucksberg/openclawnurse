# Planejamento Futuro: Fleet Dashboard

Este documento foi movido para planejamento futuro para nao misturar com o fluxo atual de VPS isoladas.
...
- push opcional para Uptime Kuma
- remediacao assistida com guardrails
